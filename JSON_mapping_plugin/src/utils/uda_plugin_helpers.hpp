...
inline std::unordered_map<std::type_index, UDA_TYPE> uda_type_index_map()
{
...
inline void set_data_block(DATA_BLOCK* data_block, const json_mapping::TypedDataArray& array)
{
